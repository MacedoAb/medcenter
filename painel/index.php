						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo $menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo $usuarios ?>"><a href="index.php?pagina=usuarios"><i class="fa fa-user-plus"></i> Usuários</a></li>
									
									<li class="<?php echo $funcionarios ?>"><a href="index.php?pagina=funcionarios"><i class="fa fa-folder-open-o"></i> Funcionários</a></li>

									<li class="<?php echo $pacientes ?>"><a href="index.php?pagina=pacientes"><i class="fa fa-file-text"></i> Pacientes</a></li>
								</ul>
							</li>
							...
							<li class="treeview <?php echo $menu_cadastros ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $grupo_acessos ?>"><a href="index.php?pagina=grupo_acessos"><i class="fa fa-user-plus"></i> Grupos</a></li>

									<li class="<?php echo $acessos ?>"><a href="index.php?pagina=acessos"><i class="fa fa-file-archive-o"></i> Acessos</a></li>
							...
							<li class="treeview <?php echo $menu_financeiro ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $rel_lucro ?>"><a href="" data-toggle="modal" data-target="#modalRelLucro"><i class="fa fa-file-text"></i> Demonstrativo de Lucro</a></li>


									<li class="<?php echo $rel_financeiro ?>"><a href="" data-toggle="modal" data-target="#modalRelFin"><i class="fa fa-file-text"></i> Relatórios Financeiro</a></li>
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo $rel_agendamentos ?>"><a href="" data-toggle="modal" data-target="#modalRelAgendamento"><i class="fa fa-file-text"></i> Relatórios Agendamentos</a></li>
